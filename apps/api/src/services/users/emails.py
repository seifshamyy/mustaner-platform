...
# Mustaner's website — footer "learn more" target, and last-resort CTA fallback.
ACADEMY_URL = os.environ.get("MUSTANER_SITE_URL", "").strip().rstrip("/") or "https://mustaner.com"


# Inline SVG logo: the Mustaner square-Kufic wordmark (25 blocks, brand gradient).
LOGO_SVG = """<svg width="140" height="33" viewBox="0 0 536 125" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Mustaner"><defs><linearGradient id="mustaner-wm" gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="536" y2="0"><stop offset="0" stop-color="#007A57"/><stop offset=".33" stop-color="#007A57"/><stop offset=".55" stop-color="#00697E"/><stop offset=".72" stop-color="#0055AC"/><stop offset="1" stop-color="#0055AC"/></linearGradient></defs><g fill="url(#mustaner-wm)"><rect x="233" y="1" width="18" height="17"/><rect x="269" y="0" width="267" height="19"/><rect x="0" y="1" width="214" height="18"/><rect x="159" y="36" width="18" height="17"/><rect x="233" y="36" width="18" height="18"/><rect x="36" y="36" width="53" height="18"/><rect x="447" y="36" width="71" height="18"/><rect x="125" y="36" width="18" height="36"/><rect x="197" y="36" width="18" height="36"/><rect x="322" y="36" width="17" height="36"/><rect x="357" y="36" width="18" height="36"/><rect x="482" y="54" width="18" height="18"/><rect x="71" y="54" width="18" height="18"/><rect x="447" y="54" width="17" height="18"/><rect x="393" y="36" width="18" height="36"/><rect x="268" y="36" width="18" height="36"/><rect x="0" y="19" width="21" height="70"/><rect x="71" y="72" width="340" height="17"/><rect x="429" y="72" width="71" height="17"/><rect x="518" y="73" width="18" height="33"/><rect x="36" y="54" width="18" height="53"/><rect x="144" y="106" width="392" height="19"/><rect x="0" y="107" width="54" height="18"/><rect x="72" y="108" width="17" height="17"/><rect x="107" y="108" width="18" height="17"/></g></svg>"""
...
STYLES = {
    ...
    "container": "max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 3px; overflow: hidden; border: 1px solid #e4eaf0;",
    "header": "padding: 48px 48px 0 48px; text-align: center;",
    "content": "padding: 36px 48px 48px 48px; text-align: center;",
    "h1": "margin: 0 0 12px 0; font-size: 22px; font-weight: 900; color: #0F2233; letter-spacing: -0.02em; line-height: 1.3;",
    "p": "margin: 0 0 20px 0; font-size: 14px; color: rgba(0,0,0,0.45); font-weight: 500; line-height: 1.7;",
    "button": "display: inline-block; padding: 14px 32px; background-color: #0055AC; color: #ffffff; text-decoration: none; border-radius: 3px; font-size: 14px; font-weight: 700; line-height: 1;",
    ...
    "code": "display: inline-block; padding: 14px 28px; background-color: #fafafa; border: 1px solid #e5e5e5; border-radius: 3px; font-size: 28px; font-weight: 900; letter-spacing: 0.12em; color: #0F2233; font-family: monospace;",
}
...
def _org_logo_img(logo_url: str, alt: str) -> str:
    ...
    Bounded to the same footprint as the Mustaner wordmark. Raster logos
    ...
    org-branded, never a broken platform mark.
    """
    return (
...
def _stat_strip(stats: list[tuple[str, int]]) -> str:
    ...
    for label, value in stats:
        cells.append(
            ...
            '<div style="font-size: 22px; font-weight: 900; color: #0F2233; '
...
def _email_layout(
    ...
    ``logo_html`` defaults to the Mustaner mark; white-labeled emails pass the
...
def send_account_creation_email(
    ...
    the subject and body name the org, the org's ``logo_url`` replaces the
    Mustaner mark when present, and the footer is reduced to a subtle
    "Powered by Mustaner". Org-less signups keep the Mustaner-branded variant
    with the website footer link.
    """
