...
export default function OnboardingSidebarBox() {
  ...
  return (
    <motion.div
      ...
      className="relative"
    >
      {/* The square grid the Kufic wordmark is drawn on, fading down from the
          top border, in brand blue. */}
      <div
        className="absolute -start-3 -end-3 -top-2 bottom-0 pointer-events-none"
        style={{
          backgroundImage: `
            linear-gradient(rgba(0,85,172,0.08) 1px, transparent 1px),
            linear-gradient(90deg, rgba(0,85,172,0.08) 1px, transparent 1px),
            linear-gradient(rgba(0,85,172,0.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(0,85,172,0.04) 1px, transparent 1px)`,
      ...
      <div className="relative">
        ...
        <div className="flex items-center gap-2">
          <ListChecks size={14} weight="bold" className="text-blue-700 shrink-0" />
          <span className="text-[11px] font-bold uppercase tracking-wider text-blue-700 flex-1 truncate">
        ...
        <div className="mt-2.5">
          ...
          <p className="mt-0.5 text-[12px] font-medium leading-snug text-neutral-800 truncate">
        ...
        <Link
          href={href}
          className="group mt-3 flex items-center justify-center gap-1.5 w-full rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[12px] font-semibold py-2 transition-colors"
        >
